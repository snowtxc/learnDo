...
<body >
    <div class="container">
        ...
        <div class="whiteContent" style="flex-direction: column;justify-content: center!important;align-items:center!important;">
                <h1 class="title2">Estimad@ : {{ $nombre_user }}</h1>
                ...
                <h1 class="description">
                    Le recordamos que hoy {{ $fecha }} tienes un Seminario virtual( {{ $evento_nombre }}  ) a traves de la plataforma : {{ $plataforma }} la hora : {{ $hora }}
                </h1>
